...
var SpotifyWebPlayer = (function (_super) {
    ...
    function SpotifyWebPlayer(props) {
        ...
        _this.toggleOffset = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                // console.log('index toggleOffset function')
                switch (_c.label) {
                    case 0:
        ...
        _this.togglePlay = function (init) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                var _this = this;
                return __generator(this, function (_c) {
                    // console.log('index toggle Play function')
                    switch (_c.label) {
                        case 0:
                            // console.log('case 0')
                        ...
                        case 1:
                            ...
                            // console.log('play options:', this.playOptions)
                        ...
                        case 7:
                            ...
                            playerState = _c.sent();
                            // console.log('play options:', this.playOptions)
                            // console.log('shouldinitizlie: ', shouldInitialize)
                            ...
                            return [4, spotify_1.play(__assign({ deviceId: currentDeviceId, offset: offset }, (shouldInitialize ? this.playOptions : this.playOptions)), token)];
                        case 8:
                            // console.log(8)
                            _c.sent();
                            return [3, 11];
    ...
    SpotifyWebPlayer.prototype.componentDidUpdate = function (prevProps, prevState) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_c) {
                // console.log('index component did update function')
                switch (_c.label) {
                    case 0:
                        // console.log('icDU case 0')
    ...
    Object.defineProperty(SpotifyWebPlayer.prototype, "playOptions", {
        get: function () {
            // console.log('defineProperty PlayOptions')
            var uris = this.props.uris;
            // console.log('uris:', uris)
            var context_uri = this.props.context_uri
            // console.log('context uri in play options:', context_uri)
            var response = {
                context_uri: undefined,
                uris: undefined,
            };
            if (uris) {
                // console.log('uris in play optiosn')
                ...
                if (ids.length > 1 && utils_1.getSpotifyURIType(ids[0]) === 'track') {
                    ...
                    // console.log('play options else to set context uri')
                    response.context_uri = ids[0];
                }
            } else if (context_uri) {
                // console.log('context uri in play options')
                response.context_uri = context_uri
            }
            return response;
        },
        enumerable: true,
    ...
    SpotifyWebPlayer.prototype.render = function () {
        ...
        if (deviceId && this.props.sendDeviceID) {
            this.props.sendDeviceID(deviceId);
        }
